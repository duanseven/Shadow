...
namespace System
{
    ...
    public static class ReflectionUtils
    {
        ...
        { 
            PropertyInfo pi = DeepGetProperty(instance.GetType(), fieldName);
            if (pi != null)
            {
                return pi.GetValue(instance, null);
            } 
            FieldInfo fi = DeepGetField(instance.GetType(), fieldName, true, false, false);
            if (fi != null)
            {
        ...
        /// <param name="mi"></param>
        /// <returns></returns>
        public static object GetFieldValue(object instance, MemberInfo mi)
        { 
        ...
        /// <param name="mi"></param>
        /// <param name="fieldValue"></param>
        public static void SetFieldValue(object instance, MemberInfo mi, object fieldValue)
        { 
            if (mi is PropertyInfo)
                ((PropertyInfo)mi).SetValue(instance, fieldValue, null);

            if (mi is FieldInfo)
                ((FieldInfo)mi).SetValue(instance, fieldValue);
        }
    }
}
